...
def test():
    data = loadmat("/home/emmamalona/solution/NLS.mat")
...
pinn = PINN()
pinn.net.load_state_dict(torch.load("/home/emmamalona/TDSE-PINN/weights/weight_muon.pt"))
...
fig.savefig(
    "/home/emmamalona/TDSE-PINN/solutions/solution_Muon.png", dpi=500, bbox_inches="tight", pad_inches=0,
)